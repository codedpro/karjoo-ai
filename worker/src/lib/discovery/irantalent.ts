/**
 * PORTED from extension/src/lib/irantalent-discovery.ts so the fleet node can run
 * the same discovery around the clock. Logic unchanged; only imports differ.
 */
import type { DiscoveredListing as BrowserDiscoveredListing } from "./types.js";
import { clampProviderAgeDays, MS_PER_DAY } from "./types.js";
