 ...
 *
 * فقط-خواندنی. فهرستِ نودهای کارگر را با سلامت/نسخه/آخرین دیده‌شدن و کاربرانِ تخصیص‌یافته
...
/**
 * فهرستِ همه‌ی نودهای کارگر را با کاربرانِ تخصیص‌یافته‌شان می‌خواند (تازه‌ترینِ ساخت اول).
