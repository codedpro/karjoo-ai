/**
 * راهنمای نصبِ افزونه‌ی کارجو (Server component) — مشترکِ صفحه‌ی «افزونه» و راهنمای شروع.
 *
 * روشِ توزیع «بارگذاریِ باز» (Load unpacked) است؛ هر گام یک جمله‌ی امری است و هر مرورگر یک
 * `<details>` در آکاردئونِ انحصاری (بدونِ JS).
 */
import { ChevronDown } from "lucide-react";

import { IconBolt, IconDownload, IconSparkle } from "@/components/dashboard/icons";
