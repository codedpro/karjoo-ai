...
/**
 * داده‌ی صفحه‌ی رزومه/پروفایل — مستقیم از DB (server-side، الگوی RSC، Track C).
 *
 * فقط-خواندنی و به userId محدود (قاعده‌ی ۴: داده‌ی هر کاربر فقط برای همان کاربر). این
 * ماژول کنارِ خودِ صفحه‌ی رزومه است (ناحیه‌ی Track C) تا با getterهای Track A قاطی نشود.
