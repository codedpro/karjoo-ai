 ...
 *
 * خزانه‌ی نشست (Track C — قاعده‌ی ۴، §۱۰ اشتراکِ دارای ورکر). کاربر بسته‌ی نشستِ *خودش* را برای
 ...
 * فقط برای replayِ اپلایِ خودکارِ همان کاربر (نودِ اشتراک‌های دارای ورکر). هیچ‌گاه cross-user؛ هیچ‌گاه
