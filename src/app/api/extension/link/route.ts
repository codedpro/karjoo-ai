 ...
 *
 * هندآفِ «بدون ورودِ دوم» (CONTEXT، قاعده‌ی ۵): افزونه یک کدِ جفت‌سازیِ یک‌بارمصرف را
 ...
 *
 * هیچ ورودِ دومی لازم نیست؛ هویت از همان حسابِ وبِ از-پیش-احرازشده (با Google) می‌آید.
