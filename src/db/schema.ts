...
export const jobBoardEnum = pgEnum("job_board", [
  ...
  "parscoders",
  "bankestekhdam",
  // آگهی‌ای که خودِ کاربر متنش را می‌دهد (کانالِ تلگرام، ایمیل، لینکدین، هر جا) و از
  // هیچ کرالری نیامده. بدونِ این مقدار، «رزومه برای آگهی‌ای که خودم دارم» ناچار بود
  // زیرِ نامِ یک بوردِ نامربوط ذخیره شود و داده‌ی منبع را دروغ نشان می‌داد.
  "custom",
]);
...
export const auditEventTypeEnum = pgEnum("audit_event_type", [
  ...
  // «سرور» (اپلای پَسیو روی ناوگانِ سرور، اشتراک‌های دارای ورکر). این چهار کدِ *بی‌پیشوند* اکنون
  ...
  // سطحِ «سرور» (پَسیو، ناوگانِ ۲۴/۷ — اشتراک‌های دارای ورکر): تفکیکِ ممیزیِ تاگلِ سرور.
 ...
 * نود می‌تواند داشته باشد (از اشتراکِ 1xai؛ بدونِ ورکر = ۰). سقف هنگامِ تخصیص اعمال می‌شود
 ...
 * تاگلِ افزونه، این سطح *پلن‌گِیت* است: فقط پلن‌هایی با workerIpLimit > ۰ (اشتراکِ دارای ورکر)
 * می‌توانند آن را مؤثر روشن کنند؛ برای بدونِ ورکر گِیتِ سرور (assertServerAutoApplyAllowed)
