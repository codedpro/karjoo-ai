 ...
 * صفحه ⇒ تا ۳۰۰۰ درخواست). حساب‌های پرمصرف تاریخچه‌ی چندصدتایی دارند؛ سقفِ ۲۰ صفحه
 * فقط درخواست‌های جدید را می‌دید و آگهی‌هایی که کاربر ماه‌ها قبل اپلای کرده بود دوباره در
 * dashboard/matches ظاهر می‌شدند.
 */
const MAX_APPLIED_PAGES = 120;
