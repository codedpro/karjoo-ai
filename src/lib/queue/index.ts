 ...
 * به وضعیت `leased` می‌روند. اگر ورکرِ B هم‌زمان اجرا شود، ردیف‌های قفل‌شده توسط A
 * را *رد* می‌کند (نه اینکه پشتشان منتظر بماند) و سراغ ردیف‌های بعدی می‌رود. در نتیجه:
 *   • هیچ دو ورکری یک وظیفه را برنمی‌دارند (بدون double-dispatch).
 *   • هیچ ورکری پشت قفل ورکر دیگر بلاک نمی‌شود (توان عملیاتی بالا).
 ...
 *
 * @param workerId شناسه‌ی نود ورکر (worker_nodes.id). برای مصرف‌کننده‌ی غیرِ ورکر
