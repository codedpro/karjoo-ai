...
const RESUME_TAILOR_SYSTEM = [
  ...
  "طول: رزومه باید **پُر و کامل** باشد (حدودِ دو صفحه‌ی A4). برای هر سابقه‌ی مهم ۳ تا ۵ bulletِ محتوادار بنویس و بخش‌های خلاصه/نکات برجسته را خالی نگذار — ولی هرگز با تکرار یا حرفِ توخالی پُر نکن.",
