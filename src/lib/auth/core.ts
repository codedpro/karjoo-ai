...
/**
 * @deprecated میراثِ OTP — پس از مهاجرت به «ورود با Google» بلااستفاده است. این توابع
 * (generateOtp/hashOtp/verifyOtp و ثابت‌های OTP_LENGTH/OTP_TTL_MS) دیگر توسطِ هیچ مسیرِ
 * تولیدی صدا زده نمی‌شوند و فقط برای اینکه core.test.ts هنوز کامپایل شود اینجا مانده‌اند.
 * TODO(cleanup-track): این بخش و تست‌های متناظرش را با هم حذف کنید.
 */
