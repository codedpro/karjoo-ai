...
/**
 * هندآفِ اتصالِ دستگاه (Device-link SSO) برای افزونه — «بدون ورودِ دوم».
 *
 * جریان (بخش CONTEXT، قاعده‌ی ۵):
 *   1) کاربر در وب از پیش با «ورود با Google» وارد شده است.
 ...
 *      هیچ ورودِ دومی لازم نیست؛ هویت از همان حسابِ وبِ احرازشده با Google می‌آید.
 *
