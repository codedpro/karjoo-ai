 ...
 *
 * این لایه نشستِ *خودِ کاربر* را برای اپلایِ خودکارِ *همان کاربر* (replay در نودِ ورکرِ
 * اشتراکِ دارای ورکر) با AES-256-GCM رمزنگاری می‌کند. هرگز اعتبارنامه‌ی خام/متنِ ساده ذخیره نمی‌شود؛
