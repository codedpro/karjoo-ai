...
/**
 * اسکیماهای zod برای مسیرهای خزانه‌ی نشست (Track C — قاعده‌ی ۴، §۱۰ اشتراکِ دارای ورکر).
 *
 ...
 *     (replay در نودِ اشتراک‌های دارای ورکر) استفاده می‌شود. هیچ‌گاه plaintext ذخیره نمی‌شود؛ این لایه
